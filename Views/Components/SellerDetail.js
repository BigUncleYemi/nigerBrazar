    ...
    <VStack>
      ...
      <HStack py={2}>
        <Image
          ...
          borderRadius={100}
          source={{
            uri: profile?.photoUrl || 'https://wallpaperaccess.com/full/317501.jpg',
          }}
          fallbackSource={{
        ...
        {isBlack ? (
          <VStack m={2}>
            ...
            <Text bold>
              ...
              <Text ml={2} color="gray.500">
                {Math.floor(moment.duration(current.diff(given)).asDays())} Days
              </Text>
            </Text>
            {!sellerCount ? 
              null
          ...
          <VStack m={2}>
            <Text style={{textTransform: 'capitalize'}} fontSize="lg" bold color="white">
            {`${profile?.lastName} ${profile?.firstName}`}
            </Text>
